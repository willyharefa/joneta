<footer>
    <div class="content-wrapper">
        <div class="row g-0 gap-4">
            <div class="col-12 col-lg-4 img-footer">
                <img src="{{ asset('/icon/icon-go-kost-2.png') }}" alt="">
                <p>Masukan dan kritikan anda akan GO-Kost menjadi batu loncatan untuk kami. Terimakasih atas supportnya selama ini.</p>
            </div>
            <div class="col-12 col-lg-7 nav-footer">
                <div class="row g-0 gap-3 justify-content-between">
                    <div class="col">
                        <h6>GO-KOST</h6>
        ...
        <hr>
        <div class="footer-copyright text-center mb-3 text-muted">
            &copy; 2022 GO-Kost. All rights reversed
        </div>
    </div>
</footer>